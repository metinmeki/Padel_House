...
class Settings(db.Model):
    ...
    # أوقات العمل
    opening_hour = db.Column(db.Integer, default=12)
    closing_hour = db.Column(db.Integer, default=4)

    # الأسعار
    price_per_hour = db.Column(db.Integer, default=40000)

    # الخصم
    discount_percentage = db.Column(db.Integer, default=25)
    discount_amount = db.Column(db.Integer, default=10000)
